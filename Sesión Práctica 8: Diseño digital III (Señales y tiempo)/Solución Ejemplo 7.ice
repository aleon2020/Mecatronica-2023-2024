    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 7: Midiendo el Contador del sistema con 4 LEDoscopios\n\nLas 4 señales del contador del sistema de 3 bits se miden con 4 LEDoscopios en paralelo.  \nCon el pulsador SW1 se cambia la visualización de cada una de ellos en los LEDs",
            "readonly": true
          },
          "position": {
            "x": -408,
        ...
        {
          "id": "412dd350-2069-4bc5-9d40-fccc1a449c9e",
          "type": "basic.info",
          "data": {
            "info": "Multiplexor 4 a 1  \nde 8 bits",
            "readonly": true
          },
          "position": {
            "x": 640,
        ...
        {
          "id": "cdd9544d-9a32-4375-b8a1-dad3691cb0f6",
          "type": "basic.info",
          "data": {
            "info": "Contador de 2 bits:  \nNúmero de canal a ver  \nen los LEDs",
            "readonly": true
          },
          "position": {
            "x": 456,
        ...
        {
          "id": "ffce1b19-02ea-43f8-8651-58706f12b8ed",
          "type": "basic.info",
          "data": {
            "info": "Contador del sistema a medir",
            "readonly": true
          },
          "position": {
            "x": -368,
