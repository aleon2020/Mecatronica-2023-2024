    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejercicio 7: Dos LEDs en oposición de fase\n\nDiseña un circuito compuesto por un pulsador conectado a dos \nLEDs. Los LEDs siempre están en estados diferentes: cuando uno \nse enciende, el otro se apaga, y vice-versa.",
            "readonly": true
          },
          "position": {
            "x": 376,
