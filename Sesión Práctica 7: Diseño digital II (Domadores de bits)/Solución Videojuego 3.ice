    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Videojuego 3: Píxel móvil\n\n* Queremos que el pixel se mueva sólo, con movimiento rectilineo uniforme.\n* Añadimos un corazón (divisor).\n* Divisor: 120_000_000: Frecuencia de 1Hz.",
            "readonly": true
          },
          "position": {
            "x": 408,
