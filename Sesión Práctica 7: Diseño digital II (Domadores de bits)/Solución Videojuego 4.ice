    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Videojuego 4: Construye tu propio contador\n\n* Cambiar frecuencia a 6Hz (Divisor: 2_000_000).\n* El contador de 3 bits lo re-hacemos desde 0, a partir de un registro de 3 bits y un sumador de 3 bits.\n* El sistema de visualizacion lo separamos.\n* Si cambiamos la velocidad a -1 el led se mueve hacia atrás.",
            "readonly": true
          },
          "position": {
            "x": 144,
